 ...
 * @param {Vec2} pos1 Vec2 position of first point.
 * @param {Vec2} pos2 Vec2 position of second point.
 ...
 * @return {boolean} True if the device is mobile or tablet.
 * @export
 */
 ...
 * @return {boolean} True if the device is tablet.
 * @export
 */
...
/**
 * Give a random number in the input range.
